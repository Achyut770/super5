...
import { teamThreeData } from "../common/helper";

const TeamThreeOptions = ({
  teamOptions,
  setTeamOptions,
  ifUserSelectPlayer,
}) => {
  ...
  useEffect(() => {
    ifUserSelectPlayer(teamThreeData);
    setTeamOptions(teamThreeData);
  }, []);
  return (
...
export default TeamThreeOptions;
